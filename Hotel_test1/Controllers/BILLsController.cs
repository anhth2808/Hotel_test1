        ...
        public ActionResult Index(string searchString, string category)
        {
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                if (!String.IsNullOrEmpty(category))
                {
                    ...
                    {
                        case "Bill_id":
                            bILLs = bILLs.Where(s => s.Bill_id.Contains(searchString));
                            break;
                        case "CustomerLastName":
                            bILLs = bILLs.Where(s => s.BOOKING.CUSTOMER.CustomerLastName.Contains(searchString));
                            break;
                        case "CustomerFirstName":
                            bILLs = bILLs.Where(s => s.BOOKING.CUSTOMER.CustomerFirstName.Contains(searchString));
                            break;
                        case "RType":
                            bILLs = bILLs.Where(s => s.BOOKING.ROOM.ROOMTYPE.RType.Contains(searchString));
                            break;
                    }
                }
            }
